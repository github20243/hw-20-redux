...
import { CreateStudent } from "../pages/innerPages/CreateStudent";
import { UpdateStudent } from "../pages/innerPages/UpdateStudent";
        ...
        { index: true, element: <Navigate to={ROUTES.COURSES} replace /> },
        {
          ...
          children: [
            ...
            },
            {
              ...
              element: <Students />,
              children: [
                { index: true, element: <StudentDoc /> },
                {path: ROUTES.CREATE, element: <CreateStudent/>},
                { path: `${ROUTES.UPDATE}/:id`, element: <UpdateStudent /> },
              ],
            },
